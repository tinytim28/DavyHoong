...
$(document).ready(function() {
    ...
    for (var i = 0; i < tds.length; i++) {
      switch (i) {
        ...
        case 2:
          ...
          break;
        case 3:
          var isAdmin = $("#isAdmin" + edit).text();
          $("#isAdmin_update").val(isAdmin);
          break;
      }
    }
  });
  ...
  $("#UpdateUser").click(function() {
    ...
    var isAdmin = $('#isAdmin_update option:selected').val();
  ...
  $('#createButton').on('click', function(){
    ...
    //var isAdminSelection = document.getElementById("isAdmin");
    //var isAdmin = isAdminSelection.options[isAdminSelection.selectedIndex].value;
    ...
    } else if (usernameNew.trim() === "" || passwordNew.trim() === "" || firstName.trim() === "" || lastName.trim() === "" || isAdmin.trim() === "") {
