...
$(document).ready(function () {
            ...
            function (responseJson) {
                ...
                if (responseJson) {
                    ...
                    for (var i = 0; i < strings.length; i += 5) {
                        ...
                        htmlcode += "<td><button id='viewtwelvemonths' type='button' class='btn btn-xs btn-primary' name='" + count + "'>Next 12 Months<\/button><button id='viewcalendaryear' type='button' class='btn btn-xs btn-primary' name='" + count + "'>Calendar Year<\/button>  <\/td>";
                        count++;
                        htmlcode += "<\/tr>";
                    }
                    htmlcode += "<\/select>";
    ...
    $("table").on('click', '#viewcalendaryear', function () {
        var view = $(this).attr("name");
        var username = $("#username" + view).text();
        var data = {
            username: username,
            type: "forecastAgentToEndYear"
        }
