        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">                
                ...
                <li>&nbsp;&nbsp;</li>
                    ...
                    %>
                <li>
                    <button type="button" class="btn btn-primary btn-xs navbar-btn loadPage" id="user_control">
                        <span class="glyphicon glyphicon-cog" aria-hidden="true"></span> User Control
                    </button>
                </li>
                    <% } %>
                <li>
