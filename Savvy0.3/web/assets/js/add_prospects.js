...
$(document).ready(function () {  
    ...
    $("table").on('click', '#DeleteProspect', function () {
        ...
        $("#myModal #cfmDelete").on("click", function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "/Savvy0.3/ProspectServlet?type=deleteProspect",
...
function refresh() {
    $.get("/Savvy0.3/ProspectServlet?type=retrieveProspectsByAgent", {
        "_": $.now()
